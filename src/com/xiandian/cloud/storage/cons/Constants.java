...
public class Constants
{
   ...
   //数据分析展示页面类型
   public static final String ANALYSISVIEW_1 = "1";
   public static final String ANALYSISVIEW_2 = "2";
   public static final String ANALYSISVIEW_3 = "3";
   //数据转换临时目录
   public static final String CONSTRTXTPATH = "\\temp\\tmp.txt";
   public static final String WORDCOUNTPATH = "\\wordcount";
