	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (request != null && request.getAttribute(FILTERED_REQUEST) != null) {
			...
			if (user == null
				...
				if (toUrl.contains("share.action") ||toUrl.contains("tocode.action")|| toUrl.contains("shareinput.action")|| toUrl.contains("downloadshare.action")
						||toUrl.contains("downloadapk.action")||toUrl.contains("extract.action"))
				{
					return true;
				}
				else
